...
| **Tổng cộng** | **~70 GB** | Cần ít nhất **75 GB trống** |
...
|-----|--------|----------|--------|---------|
| 🔵 **Standard** | Gemma4 26B + Qwen Coder 32B | 16 GB | ~36 GB | GPU 12-16 GB, lập trình viên |
| 🟣 **Full** | Cả 3 models | 16+ GB | ~61 GB | GPU 16+ GB, kỹ sư đa ngành |
...
ollama pull gemma4:26b              # 17.0 GB
ollama pull qwen2.5-coder:32b       # 20.0 GB
ollama pull nemotron-3.5-lightning  # 25.0 GB
